...
db = SQLite3::Database.new('C:/sim/sim/db/development')
...
pcap.loop() do |this,pkt|
  ...
  begin 
	  ...
	  db.execute("insert into infos valuse('#{ip.src}', '#{mac.src}', '#{sgip.phone_number}', '#{sgip.msg}')")
